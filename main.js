...
const { isValid, elementsToArray, getGitHubProject } = require('./xmlfilter');      //importando funções
...
const isAddedAfter2018AndUpdatedAfter2019 = isValid(R.__, 2018, 2019);               //High-Order, currying

const addedApps = elementsToArray(document.getElementsByTagName('application'))      //High-Order
    .filter(isAddedAfter2018AndUpdatedAfter2019)                                     //High-Order
